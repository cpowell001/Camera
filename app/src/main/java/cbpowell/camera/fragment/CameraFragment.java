...
public class CameraFragment extends BaseFragment implements
    ...
    private boolean checkCameraPermission() {
        return checkPermission(Manifest.permission.CAMERA, PERMISSION_REQUEST_CAMERA);
    }
...
//                Environment.DIRECTORY_PICTURES), "CBPowell.Camera");
//
//
//        File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(
//                Environment.DIRECTORY_PICTURES), "CBPowell.Camera");
...
//                "IMG_"+ timeStamp + ".jpg");
     ...
     * This will run until the work flow is due, and will send an event when that happens.
     */
